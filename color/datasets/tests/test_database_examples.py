"""Run database examples as end-to-end dataset checks."""
...
_EXAMPLES = _ROOT / "examples" / "database"


def test_database_examples_run() -> None:
    """Run all database examples without interactive plotting."""
