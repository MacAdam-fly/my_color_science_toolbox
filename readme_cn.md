...
```powershell
py -3.9 -m venv .venv
.\.venv\Scripts\python.exe -m pip install "https://github.com/MacAdam-fly/my_color_science_toolbox/releases/download/v1.0.3/color_science_toolbox-1.0.3-py3-none-any.whl"
